...
def get_database_metrics(db_path):
    ...
    try:
        print(f"🔍 Getting database metrics...")
        
        # Import models to get database connection
        from ..models import db
        from flask import current_app
        
        # Use current app context instead of creating new app
...
def get_application_metrics(db_path):
    ...
    try:
        from ..models import db, User, Topic, Collection, Project, Task, Review
        from flask import current_app
