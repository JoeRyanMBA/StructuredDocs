<template>
  ...
  <div class="builder-resources">
    ...
    <!-- Collections Section moved to bottom of the page -->
    <div class="collections-bottom section-card" v-if="collections && collections.length">
      <div class="section-header">
        <h3>📁 Collections</h3>
        ...
        <div class="modal-body">
          <form @submit.prevent="createCollection">
            ...
            <div class="form-actions">
              <button type="button" class="btn btn-secondary" @click="showCreateCollection = false">
                Cancel
              </button>
...
.collections-list { margin-bottom: 1rem; }
...
/* Quick actions layout; card styles are global in style.css */
.quick-actions {
  display: grid;
...
/* Buttons - rely on global styles in src/style.css */
...
.btn-success:hover {
  background: #006548; /* Consider adding a dark green variable */
}
...
/* Modals - using global .modal-overlay and .modal utilities; keep .modal.large below if needed */
