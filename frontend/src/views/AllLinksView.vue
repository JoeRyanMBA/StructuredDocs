  ...
  <div class="all-links">
    ...
    <div class="page-actions">
      ...
      <div class="action-buttons">
        <button @click="loadLinks" class="btn btn-secondary">
          🔍 Search
        </button>
        <button @click="createNewLink" class="btn btn-primary">
          ➕ Create Link
        </button>
        <button @click="refreshLinks" class="btn btn-secondary">
          🔄 Refresh
        </button>
      </div>
    </div>
    ...
    <div v-else-if="filteredLinks.length === 0" class="empty-state">
      ...
      <div class="empty-actions">
        <button @click="clearFilters" v-if="hasFilters" class="btn btn-secondary">Clear Filters</button>
